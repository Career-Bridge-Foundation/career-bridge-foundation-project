...
export function renderInvitationEmail({
  ...
  const heading = roleLabel
    ? `You've been invited to join ${name} as a ${escapeHtml(roleLabel)}`
  ...
  <div style="font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;max-width:480px;margin:0 auto;padding:32px 24px;">
    ...
    <a href="${inviteUrl}" style="display:inline-block;background:${button};color:#ffffff;text-decoration:none;padding:12px 20px;border-radius:8px;font-size:15px;font-weight:600;">Accept invitation</a>
