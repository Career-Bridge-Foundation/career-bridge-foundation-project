type MentorAddedEmailParams = { consoleUrl: string; senderName: string };
...
export function renderMentorAddedEmail({
  ...
  <div style="font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;max-width:480px;margin:0 auto;padding:32px 24px;">
    ...
    <a href="${consoleUrl}" style="display:inline-block;background:#111827;color:#ffffff;text-decoration:none;padding:12px 20px;border-radius:8px;font-size:15px;font-weight:600;">Go to your mentor console</a>
