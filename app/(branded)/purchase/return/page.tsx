...
function PurchaseReturnContent() {
  ...
  return (
    <div className="flex flex-col min-h-screen" style={{ backgroundColor: "#f3f3f3" }}>
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-20">
        <div
          className="w-full max-w-sm bg-white rounded-2xl overflow-hidden px-8 py-10 flex flex-col items-center gap-4 text-center"
          ...
          {status === "timeout" && (
            <>
              ...
              <button
                type="button"
                onClick={activate}
                className="mt-2 inline-flex items-center gap-2 px-7 py-3 text-white text-sm font-semibold rounded-md transition-opacity hover:opacity-90"
